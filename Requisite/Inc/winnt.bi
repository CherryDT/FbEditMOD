...
declare function _memcmp cdecl alias "memcmp" (byval as any ptr, byval as any ptr, byval as size_t) as integer
declare function _memcpy cdecl alias "memcpy" (byval as any ptr, byval as any ptr, byval as size_t) as any ptr
declare function _memmove cdecl alias "memmove" (byval as any ptr, byval as any ptr, byval as size_t) as any ptr
declare function _memset cdecl alias "memset" (byval as any ptr, byval as integer, byval as size_t) as any ptr

#define RtlEqualMemory(Destination,Source,Length) (iif(_memcmp((Destination),(Source),(Length))=0,TRUE,FALSE))
#define RtlMoveMemory(Destination,Source,Length) _memmove((Destination),(Source),(Length))
#define RtlCopyMemory(Destination,Source,Length) _memcpy((Destination),(Source),(Length))
#define RtlFillMemory(Destination,Length,Fill) _memset((Destination),(Fill),(Length))
#define RtlZeroMemory(Destination,Length) _memset((Destination),0,(Length))

#endif ''__win_winnt_bi__
