...
declare function MoveWindow OverLoad (byval as HWND, byval as integer, byval as integer, byval as integer, byval as integer, byval as BOOL) as BOOL
Declare Function MoveWindow OverLoad (byval as HWND, byval as RECT, byval as BOOL) as BOOL
