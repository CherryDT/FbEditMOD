...
#Ifndef __showvars_bi__
    ...
    #If __FB_DEBUG__
        ...
        Const TAB_OUTPUT        = TAB_0
        Const TAB_1				= 1				'var
        Const TAB_VAR           = TAB_1
        Const TAB_2				= 2				'float
        Const TAB_FLOAT         = TAB_2
        Const TAB_3				= 3				'string
        Const TAB_STRING        = TAB_3
        Const TAB_4				= 4				'memory
        Const TAB_MEM           = TAB_4
        Const TAB_5				= 5				'disassembler
        Const TAB_DISASM        = TAB_5
        Const TAB_6				= 6				'log
        Const TAB_LOG           = TAB_6
        ...
        #Define DebugPrint( a ) Print __FUNCTION__;":";#a;":";a
