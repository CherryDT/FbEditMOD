...
Declare Function RegNComp Cdecl Alias "regncomp" (ByRef preg As regex_t, ByRef regex As ZString, ByVal nLen As Integer, ByVal cflags As Integer) As Integer
Declare Function RegNExec Cdecl Alias "regnexec" (ByRef preg As regex_t, ByVal buffer As ZString Ptr, ByVal nLen As Integer, ByVal nmatch As Integer, ByRef pmatch As regmatch_t, ByVal eflags As Integer) As Integer
