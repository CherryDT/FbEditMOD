...
IDD_DLGEXCEPTION			equ 3600
IDC_IMGEXCEPTION			equ 3601
IDC_STCEXCEPTION1			equ 3602
IDC_STCEXCEPTION2			equ 3603
IDC_EDTEXCEPTION			equ 3604
IDC_UDCEXCEPTION			equ 3605
IDC_BTNEXCEPTIONSAVE		equ 3606
...
;	LOCAL osvi				:OSVERSIONINFO
	...
	invoke wsprintf,addr szBody,OFFSET szTrapModuleFmt,addr buffer,addr szVersion
	...
	invoke DialogBoxParam,ha.hInstance,IDD_DLGEXCEPTION,0,ADDR ErrorDlgProc,addr szBody
...
ErrorDlgProc PROC uses edi esi ebx hwnd,uMsg,wParam,lParam
	...
	.IF [uMsg] == WM_INITDIALOG
		...
		invoke SendDlgItemMessage,[hwnd],IDC_IMGEXCEPTION,STM_SETICON,eax,0
		invoke SendDlgItemMessage,[hwnd],IDC_STCEXCEPTION1,WM_SETFONT,NULL,TRUE
		invoke SendDlgItemMessage,[hwnd],IDC_STCEXCEPTION2,WM_SETFONT,NULL,TRUE
		invoke CreateFontIndirect,OFFSET LinkFont
		invoke SendDlgItemMessage,[hwnd],IDC_EDTEXCEPTION,WM_SETFONT,eax,TRUE
		invoke SendDlgItemMessage,[hwnd],IDC_EDTEXCEPTION,WM_SETTEXT,0,[lParam]

		; Set up hyperlink
		invoke SendDlgItemMessage,[hwnd],IDC_UDCEXCEPTION,WM_SETTEXT,0,OFFSET errlnktext
		invoke SendDlgItemMessage,[hwnd],IDC_UDCEXCEPTION,HLM_SETLINK,0,OFFSET errlnkaddr
		invoke SendDlgItemMessage,[hwnd],IDC_UDCEXCEPTION,HLM_SETHOTCOLOR,0,0FF0000h
		invoke SendDlgItemMessage,[hwnd],IDC_UDCEXCEPTION,HLM_SETTEXTCOLOR,0,0
		invoke SendDlgItemMessage,[hwnd],IDC_UDCEXCEPTION,HLM_SETTYPE,0,HLINK_EMAIL
		invoke SendDlgItemMessage,[hwnd],IDC_UDCEXCEPTION,HLM_SETSUBJECT,0,OFFSET errlnksubj
		invoke SendDlgItemMessage,[hwnd],IDC_UDCEXCEPTION,HLM_SETBODY,0,[lParam]
		invoke SendDlgItemMessage,[hwnd],IDC_UDCEXCEPTION,HLM_SETUNDERLINE,0,TRUE
		.if ha.hMdi
			invoke GetDlgItem,hwnd,IDC_BTNEXCEPTIONSAVE
	...
	.ELSEIF [uMsg] == WM_COMMAND
		...
		.ELSEIF eax == IDC_BTNEXCEPTIONSAVE
			invoke SendMessage,ha.hWnd,WM_COMMAND,IDM_FILE_SAVEALL,0
		.ENDIF
	.ELSEIF [uMsg] == WM_CLOSE
		invoke SendDlgItemMessage,[hwnd],IDC_EDTEXCEPTION,EM_SETSEL,0,-1
		invoke SendDlgItemMessage,[hwnd],IDC_EDTEXCEPTION,WM_COPY,0,0
		invoke SendDlgItemMessage,[hwnd],IDC_EDTEXCEPTION,WM_GETFONT,0,0
