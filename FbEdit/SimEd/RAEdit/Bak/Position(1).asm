...
CompensateTopLineAfterDelete proc uses ebx ecx, hMem:DWORD, CpMin:DWORD, CpMax:DWORD, CpTop:DWORD
	
	LOCAL NewCpTop:DWORD 
	
	
	PrintText "____CompensateTopLineAfterDelete"
...
;	PrintDec CpAB, "CpAB"   
	...
	PrintText "____End Adjust"	
	ret

CompensateTopLineAfterDelete endp