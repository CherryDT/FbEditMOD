...
;			.endif
		...
		_REM_SETMODE:
			...
			;lParam=0
			mov		eax,wParam
			mov		edx,[ebx].EDIT.fntinfo.fntht                ; *** MOD ***
			...
			.else
				...
				mov     eax, 8                                  ; *** MOD ***
			.endif
			invoke CreateCaret,[ebx].EDIT.focus,NULL,eax,edx    ; *** MOD ***
;			invoke SetCaretVisible,hWin,[esi].RAEDT.cpy         ; *** MOD ***
			invoke SetCaret,ebx,[esi].RAEDT.cpy                 ; *** MOD ***
