...
AdjustTopLine proc uses ebx ecx, hMem:DWORD, CpMin:DWORD, CpMax:DWORD, CpTopA:DWORD, CpTopB:DWORD
...
;	.endif
	...
	invoke GetCharPtr, ebx, [ebx].EDIT.edta.topcp        ; edx = line number
	mov [ebx].EDIT.edta.topln, edx
	mov eax, edx
	mul [ebx].EDIT.fntinfo.fntht
	mov [ebx].EDIT.edta.topyp, eax

	
	invoke GetCharPtr, ebx, [ebx].EDIT.edtb.topcp        ; edx = line number
	mov [ebx].EDIT.edtb.topln, edx
	mov eax, edx
	mul [ebx].EDIT.fntinfo.fntht
...
;    mov [ebx].EDIT.edta.cp, eax
    ;mov [ebx].EDIT.edtb.cp, eax
   	invoke GetCharPtr, ebx, eax                            ; edx = line number
    mov eax, edx
    mul [ebx].EDIT.fntinfo.fntht
	...
	PrintDec [ebx].EDIT.edta.topcp
	PrintDec [ebx].EDIT.edta.topln
	PrintDec [ebx].EDIT.edta.topyp
    PrintDec [ebx].EDIT.edta.cp
    PrintDec [ebx].EDIT.edta.cpy


    PrintDec [ebx].EDIT.edtb.topcp
	PrintDec [ebx].EDIT.edtb.topln
	PrintDec [ebx].EDIT.edtb.topyp
	PrintDec [ebx].EDIT.edtb.cp
    PrintDec [ebx].EDIT.edtb.cpy
