...
function InstallDll CDECL alias "InstallDll" (byval hWin as HWND,byval hInst as HINSTANCE) as ADDINHOOKS ptr EXPORT
	...
	Print "lpFunctions:TextToOutput";lpFunctions->TextToOutput
	Print "lpFunctions:SaveToIni   ";lpFunctions->SaveToIni 
	Print "lpFunctions:LoadFromIni ";lpFunctions->LoadFromIni  
	Print "lpFunctions:OpenTheFile ";lpFunctions->OpenTheFile
	Print "lpFunctions:Compile     ";lpFunctions->Compile
	Print "lpFunctions:ShowOutput  ";lpFunctions->ShowOutput
	Print "lpFunctions:TranslateAddinDialog";lpFunctions->TranslateAddinDialog
	Print "lpFunctions:FindString  ";lpFunctions->FindString 
	Print "lpFunctions:CallAddins  ";lpFunctions->CallAddins  
	Print "lpFunctions:ShowImmediate ";lpFunctions->ShowImmediate
	Print "lpFunctions:MakeProjectFileName";lpFunctions->MakeProjectFileName 
	Print "lpFunctions:HH_Help     ";lpFunctions->HH_Help 
	Print "lpFunctions:IsProjectFile";lpFunctions->IsProjectFile
