...
Function DlgProc( ByVal hDlg As HWND, ByVal uMsg As UINT, ByVal wParam As WPARAM, ByVal lParam As LPARAM ) As Integer
	...
	Select Case uMsg
	    Case WM_INITDIALOG
			...
			hTabs(TAB_7)=CreateDialogParam(hInstance, Cast(ZString ptr, IDD_TAB07), hDlg, @TabProc, NULL )
			hTabs(TAB_8)=CreateDialogParam(hInstance, Cast(ZString ptr, IDD_TAB08), hDlg, @SelProc, NULL )
			'tab output
			...
			SetParent(lpHandles->himm,hTabs(TAB_7))
			'tab var
			hList(LSV_1)=GetDlgItem(hTabs(TAB_1),IDC_LSV01)
			SendMessage( hList(LSV_1),WM_SETFONT,Cast(WPARAM,lpHandles->rafnt.hFont),TRUE)
			lpFunctions->LoadFromIni ("ShowVars", "ColsLSV1", String (MAXCOL, "4"), @CW(0), FALSE) 
			InsertColumn( hList(LSV_1), 0, CW(0), GetString( 9000, "Line" ) )
			InsertColumn( hList(LSV_1), 1, CW(1), GetString( 9001, "Function" ) )
			InsertColumn( hList(LSV_1), 2, CW(2), GetString( 9002, "Path" ) )
			InsertColumn( hList(LSV_1), 3, CW(3), GetString( 9003, "File" ) )
			InsertColumn( hList(LSV_1), 4, CW(4), GetString( 1100, "Name" ) )
			InsertColumn( hList(LSV_1), 5, CW(5), GetString( 1101, "Signed" ) )
			InsertColumn( hList(LSV_1), 6, CW(6), GetString( 1102, "Unsigned" ) )
			InsertColumn( hList(LSV_1), 7, CW(7), GetString( 1103, "Hex" ) )
			InsertColumn( hList(LSV_1), 8, CW(8), GetString( 1104, "Char" ) )
			InsertColumn( hList(LSV_1), 9, CW(9), GetString( 1105, "Bin" ) )
			...
			lpFunctions->LoadFromIni ("ShowVars", "ColsLSV2", String (MAXCOL, "4"), @CW(0), FALSE)
			InsertColumn( hList(LSV_2), 0, CW(0), GetString( 9000, "Line" ) )
			InsertColumn( hList(LSV_2), 1, CW(1), GetString( 9001, "Function" ) )
			InsertColumn( hList(LSV_2), 2, CW(2), GetString( 9002, "Path" ) )
			InsertColumn( hList(LSV_2), 3, CW(3), GetString( 9003, "File" ) )
			InsertColumn( hList(LSV_2), 4, CW(4), GetString( 1200, "Name" ) )
			InsertColumn( hList(LSV_2), 5, CW(5), GetString( 1201, "Result" ) )
			...
			lpFunctions->LoadFromIni ("ShowVars", "ColsLSV3", String (MAXCOL, "4"), @CW(0), FALSE)
			InsertColumn( hList(LSV_3), 0, CW(0), GetString( 9000, "Line" ) )
			InsertColumn( hList(LSV_3), 1, CW(1), GetString( 9001, "Function" ) )
			InsertColumn( hList(LSV_3), 2, CW(2), GetString( 9002, "Path" ) )
			InsertColumn( hList(LSV_3), 3, CW(3), GetString( 9003, "File" ) )
			InsertColumn( hList(LSV_3), 4, CW(4), GetString( 1300, "Name" ) )
			InsertColumn( hList(LSV_3), 5, CW(5), GetString( 1301, "Len" ) )
			InsertColumn( hList(LSV_3), 6, CW(6), GetString( 1302, "Content" ) )
			...
			lpFunctions->LoadFromIni ("ShowVars", "ColsLSV4", String (MAXCOL, "4"), @CW(0), FALSE)
			InsertColumn( hList(LSV_4), 0, CW(0), GetString( 9000, "Line" ) )
			InsertColumn( hList(LSV_4), 1, CW(1), GetString( 9001, "Function" ) )
			InsertColumn( hList(LSV_4), 2, CW(2), GetString( 9002, "Path" ) )
			InsertColumn( hList(LSV_4), 3, CW(3), GetString( 9003, "File" ) )
			InsertColumn( hList(LSV_4), 4, CW(4), GetString( 1400, "Name" ) )
			InsertColumn( hList(LSV_4), 5, CW(5), GetString( 1401, "Address" ) )
			InsertColumn( hList(LSV_4), 6, CW(6), GetString( 1402, "Dump" ) )
			InsertColumn( hList(LSV_4), 7, CW(7), GetString( 1403, "Ascii" ) )
			...
			lpFunctions->LoadFromIni ("ShowVars", "ColsLSV5", String (MAXCOL, "4"), @CW(0), FALSE)
			InsertColumn( hList(LSV_5), 0, CW(0), GetString( 9000, "Line" ) )
			InsertColumn( hList(LSV_5), 1, CW(1), GetString( 9001, "Function" ) )
			InsertColumn( hList(LSV_5), 2, CW(2), GetString( 9002, "Path" ) )
			InsertColumn( hList(LSV_5), 3, CW(3), GetString( 9003, "File" ) )
			InsertColumn( hList(LSV_5), 4, CW(4), GetString( 1500, "Name" ) )
			InsertColumn( hList(LSV_5), 5, CW(5), GetString( 1501, "Address" ) )
			InsertColumn( hList(LSV_5), 6, CW(6), GetString( 1502, "Hex" ) )
			InsertColumn( hList(LSV_5), 7, CW(7), GetString( 1503, "Assembler" ) )
			...
			lpFunctions->LoadFromIni ("ShowVars", "ColsLSV6", String (MAXCOL, "4"), @CW(0), FALSE)
			InsertColumn( hList(LSV_6), 0, CW(0), GetString( 9000, "Line" ) )
			InsertColumn( hList(LSV_6), 1, CW(1), GetString( 9001, "Function" ) )
			InsertColumn( hList(LSV_6), 2, CW(2), GetString( 9002, "Path" ) )
			InsertColumn( hList(LSV_6), 3, CW(3), GetString( 9003, "File" ) )
			InsertColumn( hList(LSV_6), 4, CW(4), GetString( 1600, "Time" ) )
			InsertColumn( hList(LSV_6), 5, CW(5), GetString( 1601, "Ticks" ) )
'			InsertColumn( hList(LSV_6), 6, CW(6), "Last" )
'			InsertColumn( hList(LSV_6), 7, CW(7), "Show" )
			InsertColumn( hList(LSV_6), 6, CW(6), GetString( 1602, "Show" ) )
		...
		Case WM_SIZE
			If dock1.fDocked = FALSE Then
				...
				For i = TAB_0 To TAB_7
				    MoveWindow hTabs(i), 0, 0, rc2.right, rc2.bottom, TRUE
				Next
				
				rc2.right-=17
				rc2.bottom+=2
				
				For i = LSV_1 To LSV_6
				    MoveWindow hList(i), 17, 0, rc2.right, rc2.bottom, TRUE
				Next
				
				'rc2.right+=1
				'rc2.bottom+=2
				MoveWindow lpHandles->hout, 17, 0, rc2.right, rc2.bottom, TRUE
			Else
				...
				wt=rc1.right-twt
				For i = TAB_0 To TAB_7
				    MoveWindow hTabs(i), 0, 0, wt, lpData->lpWINPOS->htout - 3, TRUE
				Next
				
				wt-=16
				For i = LSV_1 To LSV_6
				    MoveWindow hList(i), 16, 0, wt, lpData->lpWINPOS->htout - 3, TRUE
				Next

				'wt+=1
				Select Case lpData->lpWINPOS->fview And (VIEW_OUTPUT Or VIEW_IMMEDIATE)
					Case VIEW_OUTPUT
						MoveWindow(lpHandles->hout,16,0,wt,lpData->lpWINPOS->htout-3,TRUE)
						ShowWindow(lpHandles->hout,SW_SHOWNA)
						ShowWindow(lpHandles->himm,SW_HIDE)
					Case VIEW_IMMEDIATE
						MoveWindow(lpHandles->himm,16,0,wt,lpData->lpWINPOS->htout-3,TRUE)
						ShowWindow(lpHandles->himm,SW_SHOWNA)
						ShowWindow(lpHandles->hout,SW_HIDE)
					'Case VIEW_OUTPUT Or VIEW_IMMEDIATE
					'	MoveWindow(lpHandles->hout,16,0,wt\2,lpData->lpWINPOS->htout-3,TRUE)
					'	MoveWindow(lpHandles->himm,16+wt\2,0,wt-wt\2,lpData->lpWINPOS->htout-3,TRUE)
					'	ShowWindow(lpHandles->hout,SW_SHOWNA)
					'	ShowWindow(lpHandles->himm,SW_SHOWNA)
				End Select
			EndIf
		...
		Case DBG_MEM
			...
			For i = 0 To nItems( LSV_4 ) - 1
				...
				If buff = lpDBGMEM->dLabel Then
					...
					For zz = 0 To wmId - 1
						lpDBGMEM->iUpd = i + zz          ' MOD: otherwise update will be always in line 0
		...
		Case DBG_CLEAR
			...
			End If
			'
		Case DBG_SELECT                  ' wParam = IDC_RBN*
			SendDlgItemMessage hTabs(TAB_8), wParam, BM_CLICK, 0, 0
			'SendMessage( hTabs( TAB_8 ), WM_COMMAND,((BN_CLICKED Shl 16) Or wParam), 0 )
			'
		Case Else
			Return FALSE
			'
	...
	Case WM_COMMAND
		...
		Case BN_CLICKED
    		Select Case LoWord(wParam)
    			Case IDC_RBN00,IDC_RBN01,IDC_RBN02,IDC_RBN03,IDC_RBN04,IDC_RBN05,IDC_RBN06,IDC_RBN07
    		...
    		Select Case LoWord(wParam)
    			Case IDC_RBN00
    				...
    				lpFunctions->ShowImmediate (FALSE)	
    			Case IDC_RBN07	
    				lpFunctions->ShowOutput (FALSE) 
	...
	Case WM_COMMAND 
        ...
        Case STN_CLICKED
       		If bTabSelect = FALSE Then
		        SetWindowPos hTabs(TAB_8), HWND_TOP, 0, 0, 0, 0, SWP_NOMOVE Or SWP_NOSIZE Or SWP_SHOWWINDOW
		        bTabSelect = TRUE
       		Else
				ShowWindow hTabs(TAB_8), SW_HIDE
				bTabSelect = FALSE 
       		EndIf
        End Select
