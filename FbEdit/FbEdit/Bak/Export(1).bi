...
#Define IDC_STC_SCOPE               5603


Declare Function ExportDlgProc (ByVal hWin As HWND,ByVal uMsg As UINT,ByVal wParam As WPARAM,ByVal lParam As LPARAM) As Integer
