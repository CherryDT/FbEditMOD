...
#Define IDT_EXT_FILE_CHANGE_CHECK       201



Function TimerAProc(ByVal hWin As HWND,ByVal uMsg As UINT,ByVal wParam As WPARAM,ByVal lParam As LPARAM) As Integer
...
Function MainDlgProc(ByVal hWin As HWND,ByVal uMsg As UINT,ByVal wParam As WPARAM,ByVal lParam As LPARAM) As Integer
	...
	Select Case uMsg
		Case WM_INITDIALOG
			...
			SetTimer hWin, 200, 200, Cast (TIMERPROC, @TimerAProc)
			'SetTimer hWin, IDT_EXT_FILE_CHANGE_CHECK, 2000, @TimerBProc
			SetWinCaption
		...
		Case WM_COMMAND
			...
			End Select
			'
		'Case FBE_CHILDLOOSINGFOCUS
		'    Print "FBE_CHILDFOCUSKILL: "; LPARAM, ah.hred, ah.hres
		'    SbarClear
...
Function WinMain(ByVal hInst As HINSTANCE,ByVal hPrevInst As HINSTANCE,ByVal lpCmdLine As LPSTR,ByVal CmdShow As Integer) As Integer
	...
	'ThreadCreate Cast (Any Ptr, @SplashScreen)
