...
Declare Sub GetEnclosedStr OverLoad (ByRef i As Integer, ByRef Source As ZString, ByRef Dest As ZString, ByVal StartDelimiter As UByte, ByVal EndDelimiter As UByte)
Declare Sub GetEnclosedStr OverLoad (ByRef i As Integer, ByRef Source As ZString, ByRef Dest As ZString, Byref StartDelimiter As ZString, Byref EndDelimiter As ZString)
