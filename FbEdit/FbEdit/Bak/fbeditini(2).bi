...
Const szSecEdit2=			!"C0=\34Abs ACos ASin ATan2 Atn Cos Exp Fix Frac Int Log Randomize Rnd Sgn Sin Sqr Tan \34\13\10"_
								!"C1=\34ScreenList ScreenLock ScreenPtr ScreenRes ScreenSet ScreenSync ScreenUnLock Screen ScreenControl ScreenCopy ScreenEvent ScreenGLProc ScreenInfo \34\13\10"_
...
Const szSecHelp=			!"[Help]\13\10"_
								...
								!"Path=\\FreeBASIC\\Help\13\10"_
								!"CtrlF1=$H\\FB.chm\13\10"_
								!"F1=$H\\WIN32.HLP\13\10"_
								!"FbEdit=$A\\Help\\FbEdit.chm\13\10"
...
Sub UpdateColorsTo1065()
	...
	For i=1 To 15
		SetZStrEmpty (szTheme)             'MOD 26.1.2012 
...
Sub UpdateColorsTo1067()
	...
	LoadFromIni(StrPtr("Win"),StrPtr("Colors"),"44444444444444444444444444444",@fbcol,FALSE)
	...
	Else
		...
		ElseIf lret<ad.version Then
			...
			ElseIf lret<1071 Then
				UpdateSection("Block",szSecBlock)
			ElseIf lret<1072 Then
				'
			ElseIf lret<1073 Then
				'
