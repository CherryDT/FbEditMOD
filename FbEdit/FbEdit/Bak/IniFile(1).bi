...
Declare Sub GetPrivateProfileSpec (ByVal pSectionName As ZString Ptr, ByVal pKeyName As ZString Ptr, ByVal pIniSpec As ZString Ptr, ByVal pSpec As ZString Ptr, ByVal Mode As GetPrivateProfileMode)
