...
Sub SaveEditOpt(ByVal hWin As HWND)
	...
	' Fonts
	Print "DeleteObject"
	Print DeleteObject(ah.rafnt.hFont)
	Print DeleteObject(ah.rafnt.hIFont)
	Print DeleteObject(ah.rafnt.hLnrFont)
	...
	ah.rafnt.hFont=CreateFontIndirect(@lfnt)
	Print ah.rafnt.hFont
	
	lfnt.lfItalic=TRUE
	ah.rafnt.hIFont=CreateFontIndirect(@lfnt)
	Print ah.rafnt.hIFont
