...
Function FormatFunctionName (ByRef FuncDesc As ZString) As ZString Ptr 

   	Static Buffer As ZString * 1024 = Any 
    Dim    n      As Integer        = Any
    Dim    i      As Integer        = Any
	...
	*Cast (UShort Ptr, @Buffer + n) = *Cast (UShort Ptr, @" (")
	n += 2
