...
'
Declare Function GetCharTabPtr Cdecl  Alias "GetCharTabPtr" () As Any Ptr
...
#Define REM_ISCHARPOS						REM_BASE+46		' cp:Integer,0 | returns 0=normal, 1=comment block, 2=comment, 3=string
...
#Define REM_GETCELLHEIGHT                   REM_BASE+92     ' 0,0| Distance TextBaseLine/TextBaseLine
#Define REM_FOCUSEDSPLITT                   REM_BASE+93     ' 0,0| 0=no focus, 1=upper splitt has focus, 2=lower splitt has focus
