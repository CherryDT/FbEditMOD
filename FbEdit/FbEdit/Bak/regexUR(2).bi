...
Declare Function RegExec  Cdecl Alias "regexec"  (ByRef preg As regex_t, ByVal String As ZString Ptr, ByVal nmatch As Integer, ByRef pmatch As regmatch_t, ByVal eflags As Integer) As Integer
