...
Declare Function RegComp  Cdecl Alias "regcomp"  (ByRef preg As regex_t, ByRef regex As ZString, ByVal cflags As Integer) As Integer
Declare Function RegExec  Cdecl Alias "regexec"  (ByRef preg As regex_t, ByVal buffer As ZString Ptr, ByVal nmatch As Integer, ByRef pmatch As regmatch_t, ByVal eflags As Integer) As Integer
Declare Function RegError Cdecl Alias "regerror" (ByVal ErrCode As Integer, ByRef preg As regex_t, ByRef errbuf As ZString, ByVal errbuf_size As Integer) As Integer
Declare Sub      RegFree  Cdecl Alias "regfree"  (ByRef preg As regex_t)

Declare Function RegNComp Cdecl Alias "regncomp" (ByRef preg As regex_t Ptr, ByRef regex As ZString, ByVal nLen As Integer, ByVal cflags As Integer) As Integer
Declare Function RegNExec Cdecl Alias "regnexec" (ByRef preg As regex_t Ptr, ByVal buffer As ZString Ptr, ByVal nLen As Integer, ByVal nmatch As Integer, ByRef pmatch As regmatch_t, ByVal eflags As Integer) As Integer
