...
#Define PRM_DELPROPERTY					WM_USER+8		' nOwner:Integer,0     (nOwner=0 deletes all owners)
#Define PRM_REFRESHLIST					WM_USER+9		' 0,0
#Define PRM_SELOWNER					WM_USER+10		' nOwner:Integer,0     (implies PRM_REFRESHLIST)
...
#Define PRM_RESET					    WM_USER+47		' wParam=0, lParam=0
#Define PRM_GETSELTYP				    WM_USER+48		' wParam=0, lParam=0
#Define PRM_ADDPROPERTYITEM			    WM_USER+49		' wParam=0, lParam=lpPROPERTYITEM
#Define PRM_GETCURRENTOWNER             WM_USER+50      ' wParam=0, lParam=0, returns nOwner
...
#Define DEFTYPE_OBJECT					31
#Define DEFTYPE_ENDOBJECT				32
#Define DEFTYPE_METHOD					33
#Define DEFTYPE_ENDMETHOD				34
#Define DEFTYPE_IGNORE					35
#Define DEFTYPE_ENDIGNORE				36
...
Type PROPERTYITEM 
	...
	nEndLine		    As Integer				' Line number
	lpszStr			    As ZString Ptr 			' Pointer to one or more zero terminated strings
	nParts			    As Integer 				' Number of zero terminated strings
End Type
