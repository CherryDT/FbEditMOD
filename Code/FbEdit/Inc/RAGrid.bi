...
#Define GM_GETCURSEL			WM_USER+8	    '0,0|Integer                               col = LoWord (lret), row = HiWord (lret)
...
#Define GM_GETCELLDATA  		WM_USER+16	    'nRowCol:Integer,lpData:Any Ptr            nRowCol = MAKEWPARAM (Col, Row)
...
#Define GM_ENDEDIT		    	WM_USER+27	    'nRowCol:Integer,bCancel[FALSE,TRUE]       nRowCol = MAKEWPARAM (Col, Row)
...
#Define GM_CELLCONVERT	    	WM_USER+40	    'nRowCol:Integer,lpszBuffer:ZString Ptr    nRowCol = MAKEWPARAM (Col, Row)
...
#Define GM_GETBACKHIGHCOLOR	    WM_USER+46  	'wParam=0, lParam=0                    *** MOD add
#Define GM_SETBACKHIGHCOLOR	    WM_USER+47  	'wParam=nColor, lParam=0               *** MOD add
#Define GM_GETTEXTHIGHCOLOR	    WM_USER+48  	'wParam=0, lParam=0                    *** MOD add
#Define GM_SETTEXTHIGHCOLOR	    WM_USER+49  	'wParam=nColor, lParam=0               *** MOD add
