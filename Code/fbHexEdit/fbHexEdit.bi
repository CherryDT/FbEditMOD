...
'TODO!
Declare Sub fbHexEditInstall(a As DWORD, b As DWORD)
Declare Sub fbHexEditUnInstall()
...
#Define HEM_GETOFFSET			HEM_BASE+17		' wParam=0, lParam=0
#Define HEM_SETOFFSET			HEM_BASE+18		' wParam=ofs, lParam=0
#Define HEM_SETMEM				HEM_BASE+19		' wParam=nBytes, lParam=lpBytes
#Define HEM_GETMEM				HEM_BASE+20		' wParam=nBytes, lParam=lpBytes
...
#Define HEX_STYLE_ADDRESSBITS8	&H400			' 8 bit address
#Define HEX_STYLE_ADDRESSBITS16	&H800			' 16 bit address
#Define HEX_STYLE_ADDRESSBITS32	&H000			' 32 bit address
...
Const fbHexEditClassName As String = "FBHEXEDIT"
Const fbHexEditClassName As String = "FBHEXEDITCHILD"
